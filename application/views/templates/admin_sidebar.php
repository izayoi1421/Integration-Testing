<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('user'); ?>">
            ...
            <div class="sidebar-brand-text mx-2">BCIARS 386</div>
        </a>
        ...
        <?php
       $role_id = isset($this->session->userdata['role_id']) ? $this->session->userdata['role_id'] : null;
       $menu = [];
if ($role_id !== null) {
    ...
    // Handle the error when $role_id is not set
