                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="type" class="select" name="type" id="type" height="5px" style="text-align: center" required>
                                                        <option value="" disabled selected>-- Select Type --</option>
                                                        <option value="Criminal Acts">Criminal Acts</option>
                                                        <option value="Drugs">Drugs</option>                                        
                                                        <option value="Estafa">Estafa</option>
                                                        <option value="Libel/Slander">Libel/Slander</option>                                                        
                                                        <option value="Public Disturbance Noise">Public Disturbance Noise</option>
                                                        <option value="Sexual Harassment">Sexual Harassment</option>
                                                        <option value="Trespassing">Trespassing</option>            
                                                        <option value="VAWC">Violence Against Women and Children (VAWC)</option>                                                                                                                                                                                                                                                                                                                                            
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h6> <b> <label for="purpose">Purpose</label> </b> </h6>
                                                    <select class="form-control" id="status" name="status" style="text-align: center">
                                                        <option disabled selected>-- Select Purpose --</option>
                                                        <option value="Record">Record Only</option>
                                                        <option value="Pending">Request Schedule</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <form action="<?php echo site_url('report/addreport') ?>" name="form2" id="form2" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                        <input class="form-control" type="hidden" name="status" value="Record" readonly>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="type" name="type">
                                                ...
                                                <option value="Proper Waste Management">Proper Waste Management</option>
